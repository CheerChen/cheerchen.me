...
我直接给 Chrome 上最终手段，直接下 UIforETW，然后按照他说的方式跟踪，把 etl 文件导入，看火焰图。
...
{{< figure src="unnamed (1).png" title="图 1">}}

{{< figure src="unnamed (2).png" title="调用堆栈">}}
